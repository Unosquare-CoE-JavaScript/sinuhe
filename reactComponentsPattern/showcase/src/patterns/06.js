import React, { Component, useState, useEffect, useCallback, useLayoutEffect, useRef } from 'react'
...
const useClapAnimation = ({clapEl, countEl, clapTotalRef,}) => {
    const [animationTimeline, setAnimationTimeline] = useState(() => new mojs.Timeline());

    useLayoutEffect(() => {
        if (!clapEl || !countEl || !clapTotalRef) {
            return;
        }
...
/**
 * custom useEffectAfterMountHook
 */
const useEffectAfterMountHook = (cb, deps) => {
...
const MediumClap = () => {
    ...
    return (
        <button data-refkey="clapRef" ref={setRef} className={styles.clap} onClick={updateClapState}>
