  ...
  <div class="questions-ctr">
    ...
    <transition-group name="fade">
      ...
      >
        ...
        <div class="answers">
          <div class="answer" v-for="answer in question.answers" :key="answer" @click.prevent="selectAnswer(answer.is_correct)">
            {{ answer.text }}
          </div>
        </div>
      </div>
...
export default {
  name: 'Questions',
  props: ['questions', 'questionsAnswered', 'questionAnsweredMethod'],
  emits: ['questionAnswered'],
  methods: {
    selectAnswer(isCorrect) {
      this.$emit('questionAnsweredMethod', isCorrect)
    }
  }
}
</script>